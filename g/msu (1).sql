...
-- Database: `msu`
--
CREATE DATABASE IF NOT EXISTS `msu_Lalitpat` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `msu_Lalitpat`;
...
('66010915602', 'นายสมพง เสพ', 'ที่โน้น', 4.00, 4),
...
--
ALTER TABLE `faculty`
  MODIFY `f_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
